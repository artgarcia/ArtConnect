...
//char ssid[] = "BBGUEST";         // the name of your network
//char pass[] = "hendrick5";       // the name of your network
char ssid[] = "NETGEAR37";       // the name of your network
char pass[] = "sweetow!567";     // the name of your network
//char ssid[] = "ARTS_SURFACE_4";   // the name of your network
//char pass[] = "Razz170!";         // the name of your network
//
//char ssid[] = "ARTS_SOGETI_MAC";   // the name of your network
//char pass[] = "Razz170!";         // the name of your network
...
//String uri = "/devices/arduinoM0/messages/events?api-version=2016-02-03";  // endpoint to use to send message /devices/{device name}/messages/events?api-version=2016-02-03
//char hostname[] = "artArduinoIOTHUB.azure-devices.net";                   // host name address for your Azure IoT Hub
//// on device monitor generate a sas token on config page.
//char authSAS[] = "SharedAccessSignature sr=artArduinoIOTHUB.azure-devices.net&sig=7Rw%2FFKe9tKMGNx5tMigxhD%2Bg2J3LQgKx84aoYcIEmTg%3D&se=1515122960&skn=iothubowner";
...
String readSensor()
{
  ...
  // json to string 
  String myData = createJsonData("Feather1", tmp, pre, hum);
